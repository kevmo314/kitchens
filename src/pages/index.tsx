...
const IndexPage = () => {
  ...
  return (
    <Layout>
      <Header>
        <Headline>to-go crafted</Headline>
      </Header>
      <SEO title="Home" />
      <Section style={{ backgroundColor: "#E5D1E6" }}>
        ...
        <Chunk style={{ padding: "96px" }}>
          <div style={{ width: "360px" }}>
            <H2 style={{ color: "#1a1f3b" }}>
              Kitchens Confidential enables a unique food experience.
            </H2>
            <Overline>
              Combining finacial rigor and creative thinking, we help
              restaurants be ever more relevant in the future of
              delivery/take-out driven market.
            </Overline>
          </div>
        </Chunk>
      </Section>
        ...
        >
          <div style={{ maxWidth: "250px" }}>
            <Overline>
              <H3>Flavorful</H3>
              <div>
                Variety is the spice of life, which is why our partners
                represent a diversity of cuisine types. Our tapestry of
                restaurants and chefs reflect the communities we work in.
              </div>
            </Overline>
          </div>
        </Chunk>
      ...
      >
        ...
        <Chunk style={{ padding: "96px" }}>
          ...
          <div style={{ fontFamily: "Pilcrow-Medium", width: "380px" }}>
            ...
            fully builtout kitchen space and an intelligently integrated
            consumer facing and back office management tech platform allow our
            restaurant partners to focus on crafting their food and gorw their
            dream.
          </div>
        </Chunk>
      </Section>
          ...
          >
            ...
            <Section>
              <Chunk>
                ...
                <ul>
                  <li>36” Range with Convection Oven</li>
                  <li>45” Gas Floor Fryer</li>
                  <li>36” Charbroiler</li>
                  <li>36” Griddle</li>
                  <li>30”x36” 14 Gauge Stainless Steel Worktable</li>
                  <li>2 Compartment Prep Sink</li>
                  <li>3 Compartment Wash Sink</li>
                </ul>
              </Chunk>
              <Chunk>
                <strong>Refrigeration and Storage</strong>
                <ul>
                  <li>48” 2 Door Worktop Refrigerator</li>
                  <li>48” 2 Door Worktop Freezer</li>
                  <li>48” 2 Door Sandwich Prep Refrigerator</li>
                  <li>24”x36” Chrome Shelving</li>
                  <li>24”x36” Green Epoxy Shelving</li>
                </ul>
                <strong>Miscellaneous</strong>
                <ul>
                  <li>Hand Wash Sink</li>
                  <li>Pre-Rinse Hose and Spring Faucets</li>
                </ul>
              </Chunk>
            </Section>
          </div>
      ...
      >
        Behind the efficient operation are the technology solutions optimized
        for a take-out driven market. We help our restaurant partners streamline
        and manage back office functions–including supply-chain integration,
        payment APIs and marketing support.
      </Section>
      <Section>
        <Chunk>
          <img src={image11} />
      ...
      >
        ...
        <div style={{ maxWidth: "350px", padding: "48px" }}>
          <img src={counter} style={{ marginBottom: 0 }} />
          <Overline>
            <H3>A PLACE TO FEED A DIFFERENT CRAVING</H3>
            <div>
              From new dish tasting with music by local musician to hang shaking
              with chefs, COUNTER is an engaging and delightful retail
              experience centering around food and the lifestyle of food.
            </div>
          </Overline>
        </div>
        <div
        ...
        >
          <div style={{ maxWidth: "250px" }}>
            <Overline>
              ...
              <div>
                To compliment the food from our restaurant partners and culture
                we embodied, we craft a differentiating experience in the
